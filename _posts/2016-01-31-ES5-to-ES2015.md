...
Taking advantage of ES2015's new <span class="code">let</span> and <span class="code">const</span> variables I was able to change the <span class="code">var</span> declarations I had to <span class="code">let</span> which now creates a block scope for the variables.
